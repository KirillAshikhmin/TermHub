...
const ru: Dict = {
  ...
  repo: {
    ...
    amendHint: 'Переписывает последний коммит — только до отправки',
    amended: 'Коммит дополнен',
    tagCreate: 'Поставить тег…',
    tagName: 'Имя тега',
    tagCreated: 'Тег поставлен',
    tagDelete: 'Удалить тег…',
    tagDeleted: 'Тег удалён',
    fetch: 'Обновить с сервера',
    fetched: 'Обновлено',
    pickBranch: 'Выберите ветку',
    pullFrom: 'Стянуть из ветки…',
    strategyFf: 'Только перемотка',
    strategyMerge: 'Слиянием',
    strategyRebase: 'Перебазированием',
    merge: 'Влить ветку…',
    merged: 'Влито',
    rebase: 'Перебазировать на…',
    rebased: 'Перебазировано',
    stash: 'Отложить изменения',
    stashed: 'Отложено',
    stashList: 'Отложенные изменения',
    stashEmpty: 'Ничего не отложено',
    stashPop: 'Вернуть',
    stashDrop: 'Выбросить',
    stashPopped: 'Возвращено',
    stashDropped: 'Выброшено',
    discard: 'Откатить изменения',
    discarded: 'Изменения откачены',
    confirmDiscard: 'Откатить изменения в «{name}»? Это необратимо.',
    conflictMerging: 'Слияние не завершено',
    conflictRebasing: 'Перебазирование не завершено',
    conflictFiles: 'Конфликты: {files}',
    conflictHint: 'Разрешите конфликты в терминале, затем продолжите.',
    continueOp: 'Продолжить',
    abortOp: 'Прервать',
...
const en: Dict = {
  ...
  repo: {
    ...
    amendHint: 'Rewrites the last commit — only before pushing',
    ...
    pullFrom: 'Pull from branch…',
    strategyFf: 'Fast-forward only',
    strategyMerge: 'Merge',
    ...
    stash: 'Stash changes',
    stashed: 'Stashed',
    stashList: 'Stashed changes',
    stashEmpty: 'Nothing stashed',
    stashPop: 'Restore',
    stashDrop: 'Drop',
    stashPopped: 'Restored',
    stashDropped: 'Dropped',
    discard: 'Discard changes',
    discarded: 'Changes discarded',
    confirmDiscard: 'Discard changes in "{name}"? This cannot be undone.',
    conflictMerging: 'Merge not finished',
    conflictRebasing: 'Rebase not finished',
    conflictFiles: 'Conflicts: {files}',
    conflictHint: 'Resolve the conflicts in the terminal, then continue.',
    continueOp: 'Continue',
    abortOp: 'Abort',
    continued: 'Continued',
    aborted: 'Aborted',
